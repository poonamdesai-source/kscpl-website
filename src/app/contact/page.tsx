            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-start pl-4 md:pl-12">
              ...
              >
                ...
                <div className="border-l-2 border-[#70503f] pl-6 text-sm font-medium text-neutral-700 space-y-1">
                  <p className="font-bold text-neutral-900 text-base">Kalpana Struct-Con Pvt. Ltd.</p>
                  <p>1006-1008, Cyber One, Plot No - 4&6, Sector-</p>
                  <p>30A, Near Odisha Bhavan, Vashi, Navi Mumbai.</p>
                  <p>400703.</p>
                  <p className="pt-2"><strong className="text-neutral-900">For info:</strong> info@kscpl.com</p>
                </div>
